...
import com.election.PMS.Activity.LoginActivity;
...
public class Session {
    ...
    private static final String KEY_parliamentConstituencyID = "parliamentConstituencyID";

    private static final String KEY_USER_TYPE = "type";
    private static final String  KEY_boothCode = "boothCode";
    private static final String  KEY_boothName = "boothName";
    ...
    public void createProfileManageSession(String presidingOfficierId,
        ...
        editor.putString(KEY_parliamentConstituencyID, parliamentConstituencyID);
        editor.putString(KEY_USER_TYPE, type);
        editor.putString(KEY_boothCode, boothCode);
        editor.putString(KEY_boothName, boothName);
    ...
    public HashMap<String, String> getProfileManagerDetails() {
        ...
        user.put(KEY_parliamentConstituencyID, pref.getString(KEY_parliamentConstituencyID, null));
        user.put(KEY_USER_TYPE, pref.getString(KEY_USER_TYPE, null));
        user.put(KEY_boothCode, pref.getString(KEY_boothCode, null));
        user.put(KEY_boothName, pref.getString(KEY_boothName, null));
