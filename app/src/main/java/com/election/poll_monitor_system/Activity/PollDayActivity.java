...
import com.election.poll_monitor_system.Adapter.BoothAdapter;
...
public class PollDayActivity extends AppCompatActivity {
    ...
    String ids, isMockPollConducted = "null", isPollingStarted = "null";
    String serverTime;
...
//                    }
    ...
    private void poll_Datas() {
        ...
        URL = "GetPollDayData/" + ids + "/" + assemblyId;
